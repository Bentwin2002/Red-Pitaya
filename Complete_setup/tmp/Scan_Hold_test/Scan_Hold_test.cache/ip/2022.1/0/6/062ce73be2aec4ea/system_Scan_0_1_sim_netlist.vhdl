...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Scan is
  port (
    Hold_Signal_reg_0 : out STD_LOGIC;
    mode : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Scan is
  ...
  signal \^hold_signal_reg_0\ : STD_LOGIC;
  ...
  signal \min_a[14]_i_2_n_0\ : STD_LOGIC;
  ...
  signal rising_a05_in : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of Hold_Signal_i_1 : label is "soft_lutpair0";
...
begin
  Hold_Signal_reg_0 <= \^hold_signal_reg_0\;
...
\max_a[14]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
        ...
        port map (
      I0 => mode,
      I1 => \max_a0_carry__0_n_0\,
      I2 => \^hold_signal_reg_0\,
      O => \max_a[14]_i_1_n_0\
    );
...
\min_a[14]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
      I0 => mode,
      I1 => \min_a0_carry__0_n_0\,
      I2 => \^hold_signal_reg_0\,
      O => \min_a[14]_i_2_n_0\
    );
...
pulse_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
      I0 => \^hold_signal_reg_0\,
      I1 => mode,
      I2 => reset_max_min,
      O => pulse_i_2_n_0
    );
