...
--               c:/Users/BenMillward/Desktop/Complete_setup/tmp/PID_HOLD_VOLTS/PID_HOLD_VOLTS.gen/sources_1/bd/system/ip/system_Hivemind_0_1/system_Hivemind_0_1_sim_netlist.vhdl
...
entity system_Hivemind_0_1_Hivemind is
  port (
    ...
    Digital_Inputs : in STD_LOGIC_VECTOR ( 0 to 0 );
    Scan_Config : in STD_LOGIC_VECTOR ( 14 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_Hivemind_0_1_Hivemind : entity is "Hivemind";
end system_Hivemind_0_1_Hivemind;

architecture STRUCTURE of system_Hivemind_0_1_Hivemind is
  signal Mode_Scan_i_1_n_0 : STD_LOGIC;
  signal \^scan_mode\ : STD_LOGIC;
  signal \Selector_reg[0]_i_1_n_0\ : STD_LOGIC;
  signal \Selector_reg[1]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \Selector_reg[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \Selector_reg[1]_i_1\ : label is "soft_lutpair0";
begin
  Scan_Mode <= \^scan_mode\;
...
\Selector_reg[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\Selector_reg[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\Selector_reg_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
...
\Selector_reg_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
...
entity system_Hivemind_0_1 is
  port (
    ...
    Hold_PID_Voltage_in : in STD_LOGIC;
    Hold_PID_Voltage_out : out STD_LOGIC;
    Digital_Inputs : in STD_LOGIC_VECTOR ( 7 downto 0 );
    ramp_on_off : out STD_LOGIC;
    sample_and_hold : out STD_LOGIC
  );
  attribute NotValidForBitStream : boolean;
  attribute NotValidForBitStream of system_Hivemind_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_Hivemind_0_1 : entity is "system_Hivemind_0_1,Hivemind,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of system_Hivemind_0_1 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of system_Hivemind_0_1 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_Hivemind_0_1 : entity is "Hivemind,Vivado 2022.1";
end system_Hivemind_0_1;

architecture STRUCTURE of system_Hivemind_0_1 is
  signal \<const0>\ : STD_LOGIC;
  signal \^digital_inputs\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \^hold_pid_voltage_in\ : STD_LOGIC;
...
begin
  Hold_PID_Voltage_out <= \^hold_pid_voltage_in\;
  ...
  \^digital_inputs\(2 downto 0) <= Digital_Inputs(2 downto 0);
  \^forwards_backwards_in\ <= forwards_backwards_in;
  \^hold_pid_voltage_in\ <= Hold_PID_Voltage_in;
  ...
  ramp_on_off <= \^digital_inputs\(2);
  sample_and_hold <= \^digital_inputs\(1);
  zero_latch <= \^latch_value\;
GND: unisim.vcomponents.GND
     port map (
      G => \<const0>\
    );
inst: entity work.system_Hivemind_0_1_Hivemind
     port map (
      Digital_Inputs(0) => \^digital_inputs\(0),
      ...
      Select_PID(1 downto 0) => Select_PID(1 downto 0),
